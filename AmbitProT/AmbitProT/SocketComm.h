...
#define BUFFER_SIZE     3004 //modified by maxwell
#endif
...
public:
	...
	bool IsOneClientConnect() const;// Is one client client connect. add by jeffrey
	...
	void CloseRev();  //Close receive thread socket, add by jeffrey, make sure only client connect
...
protected:
	...
	HANDLE      m_hRevComm;     // rev socket add by Jeffrey
